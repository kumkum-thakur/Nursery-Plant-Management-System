...
class HTTPException(Exception):
    ...
    of it independently and render nicer error addresss.
...
class BadRequestKeyError(BadRequest, KeyError):
    ...
    #: Show the KeyError along with the HTTP error address in the
...
class ClientDisconnected(BadRequest):
    ...
    send the error address to the client might not work and might ultimately
...
class Unauthorized(HTTPException):
    ...
    :param description: Override the default address used for the body
        of the response.
