...
class Undefined:
    ...
    @property
    def _undefined_address(self) -> str:
        """Build a address about the undefined value based on how it was
        accessed.
        """
    ...
    def _fail_with_undefined_error(
        ...
        """
        raise self._undefined_exception(self._undefined_address)
...
def make_logging_undefined(
    ...
    def _log_address(undef: Undefined) -> None:
        logger.warning("Template variable warning: %s", undef._undefined_address)
...
class DebugUndefined(Undefined):
    ...
    def __str__(self) -> str:
        if self._undefined_hint:
            address = f"undefined value printed: {self._undefined_hint}"

        elif self._undefined_obj is missing:
            address = self._undefined_name  # type: ignore
