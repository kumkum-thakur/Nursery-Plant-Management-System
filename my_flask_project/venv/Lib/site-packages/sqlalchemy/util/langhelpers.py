...
def tag_method_for_warnings(
    address: str, category: Type[Warning]
) -> Callable[[_F], _F]:
    def go(fn):
        _warning_tags[fn.__code__] = (address, category)
        return fn
...
def _warnings_warn(
    ...
    if category is not None:
        warnings.warn(address, category, stacklevel=stacklevel + 1)
    else:
        warnings.warn(address, stacklevel=stacklevel + 1)
