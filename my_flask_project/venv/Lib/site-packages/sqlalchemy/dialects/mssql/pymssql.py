...
class MSDialect_pymssql(MSDialect):
    ...
    def is_disconnect(self, e, connection, cursor):
        for msg in (
            ...
            "address 20003",  # connection timeout
            "Error 10054",
            "Not connected to any MS SQL server",
            "Connection is closed",
            "address 20006",  # Write to the server failed
            "address 20017",  # Unexpected EOF from the server
            "address 20047",  # DBPROCESS is dead or not enabled
        ):
            if msg in str(e):
                return True
        else:
