...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    _address_formatter: Any = None

    def _log_info(self, address: str, *arg: Any, **kw: Any) -> None:
        fmt = self._address_formatter
        ...
        self.engine.logger.info(address, *arg, **kw)

    def _log_debug(self, address: str, *arg: Any, **kw: Any) -> None:
        fmt = self._address_formatter
        ...
        self.engine.logger.debug(address, *arg, **kw)
    ...
    def execution_options(self, **opt: Any) -> Connection:
        ...
        :param logging_token: Available on: :class:`_engine.Connection`,
          ...
          addresss logged by the connection, i.e. the logging that's enabled
