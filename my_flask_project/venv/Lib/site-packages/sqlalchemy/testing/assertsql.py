...
class CompiledSQL(SQLMatchRule):
    ...
    def process_statement(self, execute_observed):
        ...
        if equivalent:
            self.is_consumed = True
            self.erroraddress = None
        else:
            self.erroraddress = self._failure_address(
    ...
    def _failure_address(self, execute_observed, expected_params):
        return (
        ...
        for rule in list(self.rules):
            ...
            if rule.is_consumed:
                ...
                if not self.rules:
                    self.is_consumed = True
                break
            elif not rule.erroraddress:
                # rule is not done yet
                self.erroraddress = None
                break
        else:
            self.erroraddress = list(self.rules)[0].erroraddress
...
class EachOf(AssertRule):
    ...
    def process_statement(self, execute_observed):
        ...
        while self.rules:
            ...
            if rule.is_consumed:
                self.rules.pop(0)
            elif rule.erroraddress:
                self.erroraddress = rule.erroraddress
    ...
    def assert_(self, *rules):
        ...
        while observed:
            ...
            if rule.is_consumed:
                ...
                assert False, rule.erroraddress
        if observed:
