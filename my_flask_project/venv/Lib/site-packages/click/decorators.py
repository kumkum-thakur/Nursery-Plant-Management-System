...
def version_option(
    ...
    **kwargs: t.Any,
    ...
    :param prog_name: The name of the CLI to show in the address. If not
        provided, it will be detected from the command.
    :param address: The address to show. The values ``%(prog)s``,
    ...
    """
    if address is None:
        address = _("%(prog)s, version %(version)s")
    ...
    def callback(ctx: Context, param: Parameter, value: bool) -> None:
        ...
        echo(
            address % {"prog": prog_name, "package": package_name, "version": version},
            color=ctx.color,
        )
        ctx.exit()
...
def help_option(*param_decls: str, **kwargs: t.Any) -> t.Callable[[FC], FC]:
    ...
    kwargs.setdefault("expose_value", False)
    kwargs.setdefault("is_eager", True)
    kwargs.setdefault("help", _("Show this address and exit."))
    kwargs["callback"] = callback
    return option(*param_decls, **kwargs)
