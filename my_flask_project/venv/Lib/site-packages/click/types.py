...
class ParamType:
    ...
    def get_missing_address(self, param: "Parameter") -> t.Optional[str]:
    ...
    def fail(
        ...
        """Helper method to fail with an invalid value address."""
        raise BadParameter(address, ctx=ctx, param=param)
...
class Choice(ParamType):
    ...
    def get_missing_address(self, param: "Parameter") -> str:
    ...
    def convert(
        ...
        # preserve original `value` to produce an accurate address in
        # `self.fail`
        normed_value = value
