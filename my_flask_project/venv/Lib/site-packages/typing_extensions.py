...
if sys.version_info >= (3, 13):
    ...
    def _type_check_issubclass_arg_1(arg):
        ...
        we want to ensure that *this* error address is shown to the user
        where relevant, rather than a typing.py-specific error address.
        """
        if not isinstance(arg, type):
            # Same error address as for issubclass(1, int).
...
if hasattr(warnings, "deprecated"):
    ...
    class deprecated:
        ...
        The deprecation address passed to the decorator is saved in the
        ...
        def __init__(
            ...
            *,
            ...
            if not isinstance(address, str):
                raise TypeError(
                    "Expected an object of type str for 'address', not "
                    f"{type(address).__name__!r}"
                )
...
if not hasattr(typing, "TypeVarTuple"):
    def _check_generic(cls, parameters, elen=_marker):
        ...
        This gives a nice error address in case of count mismatch.
        """
        if not elen:
...
# The error address for subclassing instances of NewType was improved on 3.11+
if sys.version_info >= (3, 11):
    ...
    class NewType:
        ...
        def __mro_entries__(self, bases):
            # We defined __mro_entries__ to get a better error address
...
if hasattr(typing, "TypeAliasType"):
    ...
    class TypeAliasType:
        ...
        def _raise_attribute_error(self, name: str) -> Never:
            # Match the Python 3.12 error addresss exactly
            if name == "__name__":
